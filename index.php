...
<div id="doc">
    ...
    <ul id="nav">
        <li id="tab1"><a accesskey="1" href="./index.php?view=search">Search</a></li>
        <li id="tab2"><a accesskey="2" href="./index.php?view=explore">Explore</a></li>
        <li id="tab3"><a accesskey="3" href="./index.php?view=about">About</a></li>
    </ul><!-- end nav list -->
    </div><!-- end hd div -->
	<div id="main">
	...
	<div id="ft">
    <p class="info">
        <a accesskey="4" class="site" title="full site" href="/">Full site</a>
        <a accesskey="5" class="feed" title="feed for collection" href="../feed.xml">Subscribe</a>
	</p> 
	</div><!-- end ft div -->
</div><!-- end doc div -->
</body>
